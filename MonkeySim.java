...
public class MonkeySim {
    ...
    private static boolean isPrimeSim = false;
    ...
    /**
     * Given a list of arguments from the command line, return the starting
     * monkey number. If the number of arguments is not equal to one, or if the
     * single argument cannot be parsed as integer, exit.
     *
    ...
    /**
     * Entry point of program - run MonkeySim. Accepts one argument, the
